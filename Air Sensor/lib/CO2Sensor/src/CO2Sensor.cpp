...
const int co2_b = 671; // 100*ln(d)
const int co2_d = 822;  //current co2 concentration  
...
int CO2Sensor::read(){
  ...
  // try changing the 5000 to 3300
  _co2_v = (1-_inertia)*(v*3300.0)/(1024.0*_tries)+_co2_v*_inertia;
